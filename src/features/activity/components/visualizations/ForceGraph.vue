<template>
<div id="forcegraph" class="aw-plot-frame"></div>
</template>

<script lang="ts">
import * as d3 from 'd3';
import {
  ACTIVITY_FORCEGRAPH_LINK_STROKE,
  ACTIVITY_FORCEGRAPH_NODE_STROKE,
...
function ForceGraph(
  ...
  },
  {
    ...
    nodeStroke = ACTIVITY_FORCEGRAPH_NODE_STROKE, // node stroke color
    ...
    linkStroke = ACTIVITY_FORCEGRAPH_LINK_STROKE, // link stroke color
