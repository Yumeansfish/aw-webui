...
<div class="space-y-4">
  ...
  <div class="space-y-3">
    <div class="aw-card flex items-start justify-between gap-4">
      ...
      <input class="aw-checkbox mt-1" type="checkbox" v-model="devmode">
    </div>
    <div class="aw-card flex items-start justify-between gap-4">
      <div class="space-y-1">
      ...
      <input class="aw-checkbox mt-1" type="checkbox" v-model="showYearly">
    </div>
    <div class="aw-card flex items-start justify-between gap-4">
      <div class="space-y-1">
      ...
      <input class="aw-checkbox mt-1" type="checkbox" v-model="useMultidevice">
    </div>
    <div class="aw-card flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <input class="aw-input-sm w-full sm:w-32" v-model.number="requestTimeout" type="number">
    </div>
  </div>
